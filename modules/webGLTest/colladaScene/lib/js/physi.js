window.Physijs = (function() {
    ...
    Physijs.getObjectId = getObjectId
    Physijs.addObjectChildren = addObjectChildren
    Physijs.convertWorldPositionToObject = convertWorldPositionToObject
    Physijs.getQuatertionFromEuler = getQuatertionFromEuler
    Physijs.getEulerXYZFromQuaternion = getEulerXYZFromQuaternion
    /** -------------------------------------------------------------------------------- **/
